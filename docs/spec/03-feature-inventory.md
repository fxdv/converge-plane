...
| CAP-ISS-16 | Blocks/related/duplicate relations | ADAPT | NEXT | Inverses derived server-side; duplicate behavior explicit |
...
| CAP-PLAN-01 | Projects | ADAPT | NEXT | Lightweight cross-team outcome and issue collection |
